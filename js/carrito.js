...
const miElemento = document.getElementById('miInput');
  ...
  window.addEventListener('focus', renderizarCarrito)
  ...
  carrito.forEach((producto, indice) => {
    ...
    tarjeta.classList.add("tarjeta-producto", "tarjeta-producto-carrito");
